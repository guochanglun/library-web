var CanvasParticle = (function () {
    ...
    // 根据传入的config初始化画布
    function canvasInit(id, canvasConfig) {
        canvasConfig = canvasConfig || {};
        var canvasDiv = getELementById("canvas-particle");
        var canvasObj = getELementById(id)
        ...
        var canvas = {
            ...
            config: {
                ...
                dist: canvasConfig.dist || 600,
                e_dist: canvasConfig.e_dist || 2000,
                max_conn: 10
            }
        };
        ...
        canvas.element.width = canvasConfig.w;
        canvas.element.height = canvasConfig.h;
